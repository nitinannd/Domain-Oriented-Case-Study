...
To create the model, we can follow these suggested procedures:

1. Preprocess data which includes convert columns to appropriate formats, handle missing values.
2. Conduct appropriate exploratory analysis to extract useful insights and check whether directly useful for business or for eventual modelling/feature engineering.
...
At last, recommend strategies to manage customer churn based on our observations.
